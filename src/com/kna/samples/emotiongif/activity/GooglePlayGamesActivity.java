...
import com.kna.samples.emotiongif.basegameutils.BaseGameActivity;
import com.kna.samples.emotiongif.fragment.GameplayFragment;
import com.kna.samples.emotiongif.fragment.MainMenuFragment;
import com.kna.samples.emotiongif.fragment.WinFragment;
 ...
 */
public class GooglePlayGamesActivity extends BaseGameActivity implements MainMenuFragment.Listener,
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_google_play_games);
	 ...
	 * to the "gameplay" screen (the screen where the user types the score they
	 * want).
	 * 
	 * @param hardMode
	 ...
	 * 
	 * IMPORTANT: a method like this SHOULD NOT EXIST in your production app! It
	 * merely exists here to check that anyone running THIS PARTICULAR SAMPLE
	...
	boolean verifyPlaceholderIdsReplaced() {
		...
		int res_ids[] = new int[] { R.string.app_id, R.string.achievement_arrogant, R.string.achievement_bored,
				R.string.achievement_humble, R.string.achievement_leet, R.string.achievement_prime,
	...
	// This is not an implementation we are mathematically proud of, but it gets
	// the job done.
	...
	class AccomplishmentsOutbox {
		...
		boolean isEmpty() {
			return !mPrimeAchievement && !mHumbleAchievement && !mLeetAchievement && !mArrogantAchievement
					&& mBoredSteps == 0 && mEasyModeScore < 0 && mHardModeScore < 0;
		}
